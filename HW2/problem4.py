...
def load_G(filename_G='ncaa_games.csv'):
    ...
    '''
        ...
        ---------------------------------------------------
        py -m nose -v test4.py:test_load_G
        ---------------------------------------------------
    '''
...
def load_teams(filename_teams='ncaa_teams.csv'):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_load_teams
        ---------------------------------------------------
    '''
...
.
    ...
    ---- Outputs: --------
        * R: a dataframe of all the team names in NCAA sorted according to the descending order of their Elo ratings.
    ---- Hints: --------
...
def compute_elo(G, n, K=16):
    ...
    vals = compute_ratings(G,n, K)
    R = pd.DataFrame({'ID': range(0, len(vals)), 'Elo': vals})
    #########################################
    return R
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_compute_elo
        ---------------------------------------------------
    '''
...
def merge_team(T, R):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_merge_team
        ---------------------------------------------------
    '''
...
def rank_teams_Elo(X):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    R = X.sort_values(by = 'Elo', ascending = False)
    #########################################
    return R
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_rank_teams_Elo
        ---------------------------------------------------
    '''
