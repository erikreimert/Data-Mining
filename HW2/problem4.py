...
def load_G(filename_G='ncaa_games.csv'):
    ...
    '''  
        ...
        ---------------------------------------------------
        python3 -m nose -v test4.py:test_load_G
        ---------------------------------------------------
    '''
...
def load_teams(filename_teams='ncaa_teams.csv'):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m nose -v test4.py:test_load_teams
        ---------------------------------------------------
    '''
...
def compute_elo(G, n, K=16):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m nose -v test4.py:test_compute_elo
        ---------------------------------------------------
    '''
...
def merge_team(T, R):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m nose -v test4.py:test_merge_team
        ---------------------------------------------------
    '''
...
def rank_teams_Elo(X):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m nose -v test4.py:test_rank_teams_Elo
        ---------------------------------------------------
    '''
