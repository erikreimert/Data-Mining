...
def hello_page():
    ...
    '''
        ...
        ---------------------------------------------------
        py -m nose -v test1.py:test_hello_page
        ---------------------------------------------------
    '''

# -------------------------------------------------------
# (Demo) Now you can test the website that you have built by typing the following in the terminal: py demo1.py
# -------------------------------------------------------
#----------------------------------------------------
'''
...
def rand_page():
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_rand_page
        ---------------------------------------------------
    '''
...
def vote(ID):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_vote
        ---------------------------------------------------
    '''
...
def create_template():
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_create_template
        ---------------------------------------------------
    '''
...
def load_template(filename):
    ...
    t = templateEnv.get_template(filename)
    #########################################
    return t
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_load_template
        ---------------------------------------------------
    '''
