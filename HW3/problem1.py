...
def load_webpages(filename):
    ...
    '''
        ...
        ---------------------------------------------------
        py -m nose -v test1.py:test_load_webpages
	OR
...
def count_word_frequency(X, keyword):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    X.insert(loc= len(X.columns), column = 'Count', value  = [x.count(keyword) for x in X.Description.str.lower()])
    #########################################
    return X
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_count_word_frequency
	OR
...
def rank_word_frequency(X1):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_rank_word_frequency
	OR
    ...
    (Demo) Now you can check out the search engine that you have built by typing the following in the terminal: py demo1.py
