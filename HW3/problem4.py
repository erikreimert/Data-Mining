...
def count_out_links(A):
    ...
    '''
        ...
        ---------------------------------------------------
        py -m nose -v test4.py:test_count_out_links
	OR
...
def remove_sink_nodes(A):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    for i, val in enumerate(count_out_links(A)):
        if val == 0:
            A[:, i] = A[:, i] + 1
    #########################################
    return A
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_remove_sink_nodes
	OR
...
def compute_S(A_):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_compute_S
	OR
...
def compute_G(S, alpha):
    ...
    G = alpha*S + (1-alpha)*(1/S.shape[0])*1
    #########################################
    return G
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_compute_G
	OR
...
def random_walk_one_step(G, x):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_random_walk_one_step
	OR
...
def all_close(x, y, tol=0.01):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_all_close
	OR
...
def random_walk(G, x, tol=0.01, max_steps=100):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_random_walk
	OR
...
def add_column_pagerank(X2, x):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    X2.insert(loc = 0, column = 'PageRank', value = x)
    #########################################
    return X2
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_add_column_pagerank
	OR
...
def rank_pages(X3):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test4.py:test_rank_pages
	OR
    ...
    (Demo) Now you can test the website that you have built by typing the following in the terminal: py demo3.py
