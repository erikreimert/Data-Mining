...
def count_in_links(A):
    ...
    '''
        ...
        ---------------------------------------------------
        py -m nose -v test3.py:test_count_in_links
	OR
...
def add_column_inlinks(X1, c):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    X1.insert(loc = len(X1.columns), column = 'Inlinks', value = c)
    #########################################
    return X1
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test3.py:test_add_column_inlinks
	OR
...
def rank_inlinks(X2):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test3.py:test_rank_inlinks
	OR
    ...
    (Demo) Now you can test the website that you have built by typing the following in the terminal: py demo2.py
