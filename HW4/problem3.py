...
def extract_user_j(R_j, I):
    ...
    X = I[np.where(np.isnan(R_j), False, True)]
    y = R_j[np.where(np.isnan(R_j), False, True)]
    #########################################
    return X, y
    #-----------------
    '''
        ...
        ---------------------------------------------------
        py -m nose -v test3.py:test_extract_user_j
	OR
...
def train_user_j(X, y, a=1e-05):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test3.py:test_train_user_j
	OR
...
def update_U(R, I, a=1e-05):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test3.py:test_update_U
	OR
...
def extract_item_i(Ri_, U):
    #########################################
    ## INSERT YOUR CODE HERE (7 points)
    y = [Ri_[i] for i, val in enumerate(np.isnan(Ri_)) if not val]
    X = [U[int(x)] for x in [i for i, val in enumerate(np.isnan(Ri_)) if not val]]
    #########################################
    return X, y
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test3.py:test_extract_item_i
	OR
...
def train_item_i(X, y, a=1e-05):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test3.py:test_train_item_i
	OR
...
def update_I(R, U, a=1e-05):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test3.py:test_update_I
	OR
...
def collaborative_filtering(R, k=5, a=1e-05, n_steps=20):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test3.py:test_collaborative_filtering
    OR
