...
def transpose(X):
    ...
    '''
        ...
        ---------------------------------------------------
        py -m nose -v test1.py:test_transpose
	OR
...
def identity_matrix(n):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_identity_matrix
	OR
...
def matrix_multiplication(X, Y):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_matrix_multiplication
	OR
...
def matrix_inverse(X):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_matrix_inverse
	OR
...
def is_missing(x):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_is_missing
	OR
...
def inverse(m):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_inverse
	OR
...
def subset_vector(x, m):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    x_m = [x[i] for i, val in enumerate(m) if val]
    #########################################
    return x_m
    #-----------------
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_subset_vector
	OR
...
def subset_matrix(X, m):
    ...
    '''
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        py -m nose -v test1.py:test_subset_matrix
	OR
