...
def compute_z(x, w, b):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_compute_z
        --- OR ----
...
def compute_dz_db():
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_compute_dz_db
        --- OR ----
...
def compute_dz_dw(x):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_compute_dz_dw
        --- OR ----
...
def compute_L(z, y):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    L = np.log(1 + np.exp(z)) - y*z if z < 1000 else z*(1-y)
    #########################################
    return L
    #-----------------
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_compute_L
        --- OR ----
...
def compute_dL_dz(z, y):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    dL_dz = (1/(1+ np.exp(-z)))-y if z > -200 else -y
    #########################################
    return dL_dz
    #-----------------
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_compute_dL_dz
        --- OR ----
...
def compute_dL_db(dL_dz, dz_db):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_compute_dL_db
        --- OR ----
...
def compute_dL_dw(dL_dz, dz_dw):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_compute_dL_dw
        --- OR ----
...
def backward(x, y, z):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_backward
        --- OR ----
...
def update_b(b, dL_db, alpha=0.001):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_update_b
        --- OR ----
...
def update_w(w, dL_dw, alpha=0.001):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_update_w
        --- OR ----
...
def train(X, Y, alpha=0.001, n_epoch=100):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_train
        --- OR ----
...
def predict(x, w, b):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_predict
        --- OR ----
