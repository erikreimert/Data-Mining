...
def update_memory(a, r, Rt, Ct):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_update_memory
        --- OR ----
...
def choose_action_explore(c):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_choose_action_explore
        --- OR ----
...
def choose_action_exploit(Rt, Ct):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_choose_action_exploit
        --- OR ----
...
def choose_action(Rt, Ct, e=0.05):
    ...
    '''
        ...
        --- OR ----
        py -m nose -v test1.py:test_choose_action
        --- OR ----
...
'''
    TEST problem 1:
        ...
        ----------- Problem 1 (100 points in total)--------------------- ... ok
        * (25 points) update_memory ... ok
        * (25 points) choose_action_explore ... ok
        * (25 points) choose_action_exploit ... ok
        * (25 points) choose_action ... ok
        ----------------------------------------------------------------------
